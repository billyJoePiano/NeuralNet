...
public class ShortTermMemory extends CachingNeuron {
    ...
    public ShortTermMemory(ShortTermMemory cloneFrom) {
        super(cloneFrom);
     ...
     *
     */
    public ShortTermMemory(SignalProvider input, int fadeOutOnly)
            throws IllegalArgumentException {

        this(input, 0, 0, 1, fadeOutOnly, (short)0);
    }

    public ShortTermMemory(SignalProvider input, int delay, int fadeIn, int length, int fadeOut, short defaultVal)
            throws IllegalArgumentException {
    ...
    public void after() {
        ...
        // the NEXT round, while the neuron's current output is not reliant upon its current input (though current

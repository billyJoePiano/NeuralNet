...
public abstract class CachingNeuron implements Neuron {
    ...
    private Set<SignalConsumer> consumers = new LinkedHashSet<>();
    private Set<SignalConsumer> consumersView = Collections.unmodifiableSet(this.consumers);
    ...
    public void setInputs(List<SignalProvider> inputs) throws IllegalArgumentException {
        ProvidersWithView oldInputs = new ProvidersWithView(this.inputs, this.inputsView);
        ProvidersWithView newInputs = this.validateInputs(inputs);
